...
public class SettingsShortcutActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public static String getToolbarLabel(Context context,int i)
    {
        if ( i == TextView.FUNCTION_KAGIKAKKO ){
            ...
            return SettingsShortcutActivity.getTblToolName(context)[i];
        }
    }
    
    public  static String[]  getTblToolName(Context context)
    {
        return context.getApplicationContext().getResources().getStringArray(R.array.table_toolname_array);
    }
